...
public class SdkfluxIup {
    ...
    // http://localhost:8080/api/vup/sdkfluxiup

    @GetMapping("sdkfluxiup")
    public Flux<VupSdkDataReact> getSDKflux() throws VupExceptionNOTFOUND {
        ...
        return vup.FluxVupReactIup(paramsdk);
